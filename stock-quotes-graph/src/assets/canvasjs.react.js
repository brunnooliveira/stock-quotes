...
class CanvasJSChart extends Component {
  constructor(props){
    ...
    this.containerProps = props.containerProps.height ? props.containerProps.height 
      : this.options.height ? this.options.height + "px" : '400px';
    this.chatContainerId = "canvasjs-react-chart-container-" + CanvasJSChart._cjsContainerId++;
  }
  ...
  render(){
    return(
      <div id={this.chatContainerId} style={this.containerProps} />
    );
  }
}
